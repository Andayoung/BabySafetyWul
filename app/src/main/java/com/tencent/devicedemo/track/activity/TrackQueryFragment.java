...
import com.tencent.devicedemo.track.dialog.TrackAnalysisDialog;
import com.tencent.devicedemo.track.dialog.TrackAnalysisInfoLayout;
...
import com.tencent.devicedemo.track.utils.ViewUtil;
...
public class TrackQueryFragment extends Fragment implements CompoundButton.OnCheckedChangeListener
    ...
    private void init() {
        ...
        trackAnalysisInfoLayout = new TrackAnalysisInfoLayout(getActivity(), mapUtil.baiduMap);
        initListener();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            /*case R.id.btn_activity_options:
                ViewUtil.startActivityForResult(getActivity(), TrackQueryOptionsActivity.class, Constants.REQUEST_CODE);
                break;*/
